...
class LornaJaneCrawler < ApplicationCrawler
  BASE_URL = 'https://shop.lornajane.com.au'
  STORE_URL = 'https://www.lornajane.com.au'
  PER_PAGE = 250
  MAX_PAGES = 20
  ...
  def crawl_all
    ...
    Rails.logger.error "LornaJaneCrawler error: #{e.message}"
    self
  end
